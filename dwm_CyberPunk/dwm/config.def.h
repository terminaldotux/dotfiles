...
static const char col_2[]           = "#00AAFF";
static const char col_3[]           = "#ABE2FE";
static const char col_4[]           = "#EEEEEE";
static const char col_5[]           = "#FFFFFF";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_3, col_1, col_2 },
	[SchemeSel]  = { col_4, col_1, col_2  },
};
...
static const char *flameshotgui[]  = { "flatpak", "run", "org.flameshot.Flameshot", "gui", NULL };
static const char *flameshotcap[]  = { "flatpak", "run", "org.flameshot.Flameshot", "full", "-c", NULL };
static const char *flameshotl[]    = { "flatpak", "run", "org.flameshot.Flameshot", "launcher", NULL };

static Key keys[] = {
	/* modifier                     key        function        argument */
        { 0,                            XK_Print,  spawn,          {.v = flameshotcap } },
        { MODKEY,                       XK_Print,  spawn,          {.v = flameshotgui } },
	{ MODKEY|ShiftMask,             XK_Print,  spawn,          {.v = flameshotl } },
	...
	{ ControlMask|ALTKEY,		XK_Down,      moveresizeedge, {.v = "b"} },
	{ ControlMask|ALTKEY,		XK_Up,      moveresizeedge, {.v = "t"} },
	{ ControlMask|ALTKEY, 		XK_Right,      moveresizeedge, {.v = "r"} },
	{ ControlMask|ALTKEY,		XK_Left,      moveresizeedge, {.v = "l"} },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
